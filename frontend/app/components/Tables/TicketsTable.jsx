            ...
            { !error && (
                ...
                >
                    ...
                    <TableBody items={rowsToRender}>
                        {(item) => (
                            <TableRow key={item.key} className="h-15 max-h-10 bg-transparent ">
                                {(columnKey) => (
                                    <TableCell className="py-2 px-4  gap-1 overflow-hidden bg-transparent ">{renderCell(item, columnKey)}</TableCell>
                                )}
                            </TableRow>
                        )}
                    </TableBody>
