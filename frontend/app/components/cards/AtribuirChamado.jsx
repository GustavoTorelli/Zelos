        ...
        <div className="w-72 h-48 flex flex-col justify-between bg-[#1d1e21] rounded-xl shadow-[-4px_8px_15px_-9px_rgba(0,0,0,0.7)] p-5 m-2">
            ...
            <div className="flex flex-col h-full gap-2">
                ...
                <div className="flex flex-col gap-2">
                    <div className="w-full h-1 bg-[#B91C1C] rounded-full"></div>
                    <h1 className="text-sm font-semibold text-gray-100 tracking-wide">
                        Chamado <span className="text-[#B91C1C]">#1234567</span>
                    </h1>
                </div>
            ...
            <button
                ...
                className="mt-3 bg-gradient-to-r from-red-700 to-red-600 text-white font-bold py-2 px-4 rounded-md hover:from-red-800 hover:to-red-700 transition ease-in-out duration-150 cursor-pointer w-full"
            >
                Atribuir
            </button>
        </div>
