...
export default function ChamadoExcluido({ show, onClose, title, description }) {
    if (!show) return null;
            ...
            <div className="flex flex-col gap-2 w-60 sm:w-72 text-[10px] sm:text-xs mt-10
                ...
                <div className="flex items-center justify-between w-full h-12 sm:h-14">
                    <div className="flex gap-2">
                        ...
                        <div>
                            <p className="text-white">Chamado excluido!</p>
                            <p className="text-gray-500">Você excluiu um chamado.</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
